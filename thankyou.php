...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Cartzilla | Checkout v.2 - Thank You Page</title>
      ...
      <div class="offcanvas-body tab-content py-2 py-sm-3">
        ...
        <div class="tab-pane fade show active" id="delivery-tab-pane" role="tabpanel" aria-labelledby="delivery-tab">
          ...
          <div class="collapse delivery-address" id="deliveryAddressAdd">
            <div class="nav mb-4">
              <a class="nav-link animate-underline p-0" href="-2.html" data-bs-toggle="collapse" aria-expanded="true" aria-controls="deliveryAddressOptions deliveryAddressAdd">
                <i class="ci-chevron-left fs-lg ms-n1 me-1"></i>
          ...
          <div class="nav">
            <a class="nav-link hiding-collapse-toggle animate-underline collapsed px-0 mt-4" href="-2.html" data-bs-toggle="collapse" aria-expanded="false" aria-controls="deliveryAddressOptions deliveryAddressAdd">
        ...
        <div class="tab-pane fade" id="pickup-tab-pane" role="tabpanel" aria-labelledby="pickup-tab">
          ...
          <div class="collapse pickup-options" id="pickupStoreAdd">
            <div class="nav mb-4">
              <a class="nav-link animate-underline p-0" href="-3.html" data-bs-toggle="collapse" aria-expanded="true" aria-controls="pickupStoreOptions pickupStoreAdd">
                <i class="ci-chevron-left fs-lg ms-n1 me-1"></i>
          ...
          <!-- Add address collapse toggle -->
          <div class="nav">
            <a class="nav-link hiding-collapse-toggle animate-underline collapsed px-0 mt-4" href="-3.html" data-bs-toggle="collapse" aria-expanded="false" aria-controls="pickupStoreOptions pickupStoreAdd">
            ...
            <div class="accordion-collapse collapse" id="home" aria-labelledby="headingHome" data-bs-parent="#navigation">
              <div class="accordion-body pb-3">
                <ul class="dropdown-menu show position-static shadow-none">
                  ...
                  <li class="hover-effect-opacity px-2 mx-n2">
                    <a class="dropdown-item d-block mb-0" href="index.html">
                  ...
                  <div class="d-flex flex-column gap-4">
                    <div style="min-width: 190px">
                      ...
                      <ul class="nav flex-column gap-2 mt-0">
                        ...
                        <li class="d-flex w-100 pt-1">
                          <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-product-grocery.html">Product General Info</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                      ...
                      <ul class="nav flex-column gap-2 mt-0">
                        <li class="d-flex w-100 pt-1">
                          <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop.html">Catalog with Top Filters</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
      ...
      <section class="container pt-3 pt-sm-4 pb-5 mb-2 mb-md-3 mb-lg-4 mb-xl-5">
        <div class="position-relative overflow-hidden rounded-5 p-4 p-sm-5" style="background-color: var(--cz-success-border-subtle)">
          <div class="position-relative z-2 text-center py-4 py-md-5 my-md-2 my-lg-5 mx-auto" style="max-width: 536px">
            ...
            <p class="text-dark-emphasis pb-3 pb-sm-4">Your order <span class="fw-semibold">#234000</span> accepted and will be processed shortly. Expect our courier <span class="fw-semibold">today (Sunday, May 9) at 12:00 - 14:00.</span></p>
            <a class="btn btn-lg btn-dark rounded-pill mb-xl-4" href="shop-catalog-grocery.html">Continue shopping</a>
          </div>
          <img src="assets/img/shop/grocery/thankyou-bg-1.png" class="animate-up-down position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Background image">
          <img src="assets/img/shop/grocery/thankyou-bg-2.png" class="animate-down-up position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Background image">
        </div>
      </section>
