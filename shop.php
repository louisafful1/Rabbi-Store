<!DOCTYPE html>
<html lang="en" data-bs-theme="light" data-pwa="true"><meta http-equiv="content-type" content="text/html;charset=utf-8" />
<head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="shoppingCart" tabindex="-1" aria-labelledby="shoppingCartLabel" style="width: 500px">
      ...
      <div class="offcanvas-body text-center">
        ...
        <a class="btn btn-dark rounded-pill" href="shop.html">Continue shopping</a>
      </div>
    </div>
    ...
    <main class="content-wrapper">
      <div class="container pb-5 mb-2 mb-sm-3 mb-lg-4 mb-xl-5">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 gy-5" id="productGrid">
          ...
          <div class="col">
            <div class="animate-underline mb-sm-2">
              <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3 opacity-50 pe-none" href="shop-product-furniture.html">
