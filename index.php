...
<!-- End of head -->
  ...
  <?php  include "include/cart_canvas.php";?> 
<!-- End of shopping cart canvas -->
    ...
    <div class="container position-relative d-flex justify-content-between z-1 py-3">
      <div class="nav animate-underline">
        ...
        <a class="nav-link animate-target fs-xs fw-semibold p-0" href="tel:+15053753082">+233&nbsp;59&nbsp;141&nbsp;4352</a>
      </div>
    ...
    <main class="content-wrapper">
          ...
          <div class="swiper" id="captions" data-swiper="{
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide bg-body-tertiary text-center">
                ...
                <p class="h4 mb-4">GHC 1,250.00</p>
                <a class="btn btn-lg btn-dark rounded-pill" href="shop.php">
                  Shop now
            ...
            <div class="col col-md-4 col-lg-3 col-xl-2 mb-4">
              <div class="category-card w-100 text-center px-1 px-lg-2 px-xxl-3 mx-auto" style="min-width: 165px">
                <div class="category-card-body">
                  <a class="d-block text-decoration-none" href="shop.php">
                  ...
                  <ul class="category-card-list nav w-100 flex-column gap-1 pt-3">
                    <li class="w-100">
                      <a class="nav-link justify-content-center min-w-0 w-100 fw-normal hover-effect-underline p-0" href="shop.php">
      ...
      <section class="container pb-5 mt-md-n2 mb-2 mb-sm-3 mb-md-4 mb-xl-5" id="popular_items">
        ...
        <div class="d-flex align-items-center justify-content-between border-bottom pb-3 pb-md-4">
          ...
          <div class="nav ms-3">
            <a class="nav-link animate-underline px-0 py-2" href="shop.php">
...
?>
              ...
              <!-- <div class="swiper-slide">
                <div class="animate-underline">
                  ...
                  <div class="h6">GHC 140.00 <del class="fs-sm fw-normal text-body-tertiary">GHC 160.00</del></div>
                  <div class="d-flex gap-2">
                    <button type="button" class="btn btn-dark w-100 rounded-pill px-3">Add to cart</button>
                    <button type="button" class="btn btn-icon btn-secondary rounded-circle animate-pulse" aria-label="Add to wishlist">
                      <i class="ci-heart fs-base animate-target"></i>
            ...
            <div class="ratio" id="hotspots" style="--cz-aspect-ratio: calc(500 / 526 * 100%)">
              ...
              <a class="btn btn-icon btn-sm btn-light rounded-circle shadow position-absolute z-2 d-none-rtl" href="#!" style="top: 63.4%; left: 75.8%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="top" data-bs-custom-class="popover-sm" data-bs-content="
                <div class=&quot;d-flex align-items-start position-relative&quot;>
                  <img src=_assets/img/home/furniture/gallery/hotspot01.php width=&quot;64&quot; alt=&quot;Image&quot;>
                  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                    <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_shop.php>Indigo coushy low sofa</a>
                    <div class=&quot;h6 mb-0&quot;>GHC 856.00</div>
                  </div>
                </div>
              ...
              <a class="btn btn-icon btn-sm btn-light rounded-circle shadow position-absolute z-2 d-none-rtl" href="#!" style="top: 60.2%; left: 15.7%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="bottom" data-bs-custom-class="popover-sm" data-bs-content="
                <div class=&quot;d-flex align-items-start position-relative&quot;>
                  <img src=_assets/img/home/furniture/gallery/hotspot02.php width=&quot;64&quot; alt=&quot;Image&quot;>
                  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                    <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_shop.php>Ergonomic beige armchair</a>
                    <div class=&quot;h6 mb-0&quot;>GHC 235.00</div>
                  </div>
                </div>
              " tabindex="1" aria-label="Hotspot">
                <i class="ci-plus fs-sm"></i>
              ...
              <a class="btn btn-icon btn-sm btn-light rounded-circle shadow position-absolute z-2 start-50 translate-middle-x" href="#!" style="top: 25.8%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="top" data-bs-custom-class="popover-sm" data-bs-content="
                <div class=&quot;d-flex align-items-start position-relative&quot;>
                  <img src=_assets/img/home/furniture/gallery/hotspot03.php width=&quot;64&quot; alt=&quot;Image&quot;>
                  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                    <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_shop.php>Waves modern painting</a>
                    <div class=&quot;h6 mb-0&quot;>GHC 74.99</div>
                  </div>
                </div>
              " tabindex="1" aria-label="Hotspot">
                <i class="ci-plus fs-sm"></i>
    ...
    <footer class="footer bg-dark pb-4 py-lg-5" data-bs-theme="dark">
      <div class="container pt-5 pt-lg-4 mt-sm-2 mt-md-3">
        ...
        <p class="fs-xs text-body text-center pt-lg-4 mt-n2 mt-md-0 mb-0">
          © All rights reserved. Made by <span class="animate-underline"><a class="animate-target text-white text-decoration-none" href="https://createx.studio/" target="_blank" rel="noreferrer">Createx Studio</a></span>
        </p>
      </div>
    </footer>
